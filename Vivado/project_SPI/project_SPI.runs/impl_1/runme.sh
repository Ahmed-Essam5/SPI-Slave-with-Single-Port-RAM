...
HD_PWD='D:/Extra/Vivado_Kareem_Waseem/project_SPI/project_SPI/project_SPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_top_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_top_module.tcl -notrace
